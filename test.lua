...
homepos = new (-454,4,1504)
targetPos = new(-410,40,1534)
mypos=trilaterate(A,B,C)

offset = homepos-mypos
drone.setAcceleration(8)
drone.move(offset.x,offset.y,offset.z)